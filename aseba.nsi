...
;Pages
  ...
  !define MUI_STARTMENUPAGE_DEFAULTFOLDER "Aseba Studio"
...
;Name and file (Defined here to be translation-enabled)
  ...
  OutFile "aseba-bin-${VERSION}-win32.exe"
  Name ${MY_NAME}
...
SectionGroup "!Aseba" GroupAseba
	Section "!Aseba Studio IDE" SecStudio
		...
		File "${ASEBA_BIN}\strip\asebastudio.exe"
		!ifdef DEV_VERSION
...
SectionGroup $(NAME_GroupCLI) GroupCLI
	...
	Section /o $(NAME_SecTools) SecTools
		...
		File "${ASEBA_BIN}\strip\asebaexec.exe"
		File "${ASEBA_BIN}\strip\asebadummynode.exe"
		!endif ; DEBUG_PACKAGE
